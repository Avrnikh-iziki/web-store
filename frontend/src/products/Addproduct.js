...
class Addproduct extends Component {
    ...
    onChangeimage = e => {
        ...
        for (let x of files) {
            ...
            reader.onload = () => {
                this.setState({
                    previewsource: [...this.state.previewsource, `url(${reader.result})`],
    ...
    onSubmit = e => {
        e.preventDefault();
        var category = (this.state.category === "" && this.state.categorys.length > 0)
                    ...
                    <form onSubmit={this.onSubmit}>
                        ...
                        <div className="form-group row mb-2 mt-4 pt-4 mb-4 pb-4">
                            ...
                            <div className="col-sm-3 mb-1 ">
                                {(this.state.detail && this.state.detail1)
                                    ? <button className="btn btn-success but" onClick={this.handledetails}>Add</button>
                                    : <button className="btn btn-success but disabled" onClick={this.handledetails}>Add</button>
                                }
                            </div>
                        ...
                        <div className="form-group row mb-2">
                            ...
                            <div className="image_in1 mt-3 mb-3 pt-3 pb-1">
                                {this.state.data &&
                                    this.state.previewsource.map((el, index) => {
                                        return <div key={index}>
                                            <div
                                                style={{ backgroundImage: `${el}`, backgroundSize: "100%  100%", backgroundRepeat: "no-repeat" }}
                                                className="load-in">
